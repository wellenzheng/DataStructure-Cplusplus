...
int ForbiddenCheck(ChessAnalyzeData *checkData, Psquare p0)
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		else if (adjsame[i] == 2) //��������
		{
			...
			//�����ж�
			if (checkData[i].adjemptyNxt == 1 && checkData[i].jumpsameNxt == 1 && (checkData[i].jumpemptyNxt > 1 || checkData[i].jumpemptyNxt == 1 && checkData[i].jumpjumpsameNxt == 0) && (checkData[i].adjemptyPre > 1 || checkData[i].adjemptyPre == 1 && checkData[i].jumpsamePre == 0))
			{
				if (KeyPointForbiddenCheck(p0, direction, checkData[i].adjsameNxt) == NO_FORBIDDEN)
					CountThree++;
			}

			if (checkData[i].adjemptyPre == 1 && checkData[i].jumpsamePre == 1 && (checkData[i].jumpemptyPre > 1 || checkData[i].jumpemptyPre == 1 && checkData[i].jumpjumpsamePre == 0) && (checkData[i].adjemptyNxt > 1 || checkData[i].adjemptyNxt == 1 && checkData[i].jumpsameNxt == 0))
			{
				if (KeyPointForbiddenCheck(p0, -direction, checkData[i].adjsamePre) == NO_FORBIDDEN)
					CountThree++;
			}
		...
		else if (adjsame[i] == 1) //����һ��
		{
			...
			//�����ж�
			if (checkData[i].adjemptyNxt == 1 && checkData[i].jumpsameNxt == 2 && (checkData[i].jumpemptyNxt > 1 || checkData[i].jumpemptyNxt == 1 && checkData[i].jumpjumpsameNxt == 0) &&
				(checkData[i].adjemptyPre > 1 || checkData[i].adjemptyPre == 1 && checkData[i].jumpsamePre == 0))
			{
				if (KeyPointForbiddenCheck(p0, direction, checkData[i].adjsameNxt) == NO_FORBIDDEN)
					CountThree++;
			...
			if (checkData[i].adjemptyPre == 1 && checkData[i].jumpsamePre == 2 && (checkData[i].jumpemptyPre > 1 || checkData[i].jumpemptyPre == 1 && checkData[i].jumpjumpsamePre == 0) &&
				(checkData[i].adjemptyNxt > 1 || checkData[i].adjemptyNxt == 1 && checkData[i].jumpsameNxt == 0))
			{
				if (KeyPointForbiddenCheck(p0, -direction, checkData[i].adjsamePre) == NO_FORBIDDEN)
					CountThree++;
